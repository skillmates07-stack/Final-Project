              ...
              {isProfileMenuOpen && (
                <div className="absolute right-0 top-12 mt-2 w-56 origin-top-right rounded-md border border-gray-200 bg-white z-50 overflow-hidden">
                  <div>
                    ...
                    <Link
                      to="/my-dashboard?tab=applications"
                      className="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 gap-2"
                    >
                      <Briefcase size={16} />
                      Applied Jobs
            ...
            {userDataLoading ? (
              ...
              <div className="mt-6 pt-6 border-t border-gray-200 space-y-3">
                <Link
                  to="/recruiter-login"
                  onClick={toggleMenu}
                  className="block w-full bg-gray-100 text-gray-700 px-4 py-2.5 rounded-md text-sm font-medium hover:bg-gray-200 text-center"
                >
                  Recruiter Login
                </Link>
                <Link
                  to="/candidate-login"
                  onClick={toggleMenu}
                  className="block w-full bg-blue-600 text-white px-4 py-2.5 rounded-md text-sm font-medium hover:bg-blue-700 text-center cursor-pointer"
                >
                  Candidate Login
                </Link>
              </div>
